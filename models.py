...
class BlockGroupBorder(models.Model):
    state_fips = models.CharField(max_length=2)
    cnty_fips = models.CharField(max_length=3)
    stcofips = models.CharField(max_length=5)
    tract = models.CharField(max_length=6)
    blkgrp = models.CharField(max_length=1)
    fips = models.CharField(max_length=12)
    pop2000 = models.IntegerField()
    pop2007 = models.FloatField()
    pop00_sqmi = models.FloatField()
    pop07_sqmi = models.FloatField()
    white = models.IntegerField()
    black = models.IntegerField()
    ...
    class Meta:
        ordering = ['state_fips','cnty_fips',]
        index_together = [['state_fips', 'cnty_fips'], ]

    def __unicode__(self):
        return str(self.state_fips)+' '+str(self.cnty_fips)

# Auto-generated `LayerMapping` dictionary for BlockGroupBorder model
blockgroupborder_mapping = {
    'state_fips' : 'STATE_FIPS',
    'cnty_fips' : 'CNTY_FIPS',
    'stcofips' : 'STCOFIPS',
    'tract' : 'TRACT',
