...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Zipcode.type'
        db.add_column('django_geo_world_zipcode', 'type',
                      self.gf('django.db.models.fields.CharField')(default='STANDARD', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Zipcode.type'
        db.delete_column('django_geo_world_zipcode', 'type')
    ...
    models = {
        ...
        'django_geo_world.stateborder': {
            'Meta': {'object_name': 'StateBorder', 'ordering': "['state_name']"},
            'age_18_21': ('django.db.models.fields.IntegerField', [], {}),
            'age_22_29': ('django.db.models.fields.IntegerField', [], {}),
            'age_30_39': ('django.db.models.fields.IntegerField', [], {}),
            'age_40_49': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'django_geo_world.urbanborder': {
            'Meta': {'object_name': 'UrbanBorder', 'ordering': "['name']"},
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {}),
            'households': ('django.db.models.fields.IntegerField', [], {}),
            'hse_units': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'django_geo_world.uscityborder': {
            'Meta': {'object_name': 'USCityBorder', 'ordering': "['st_abbrev', 'name']"},
