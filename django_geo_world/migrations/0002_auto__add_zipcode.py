...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('django_geo_world_zipcode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('zip', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('primary_city', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('acceptable_cities', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('unacceptable_cities', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('county', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('timezone', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('area_codes', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('latitude', self.gf('django.db.models.fields.FloatField')()),
            ('longitude', self.gf('django.db.models.fields.FloatField')()),
            ('world_region', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('decommissioned', self.gf('django.db.models.fields.BooleanField')()),
            ('estimated_population', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=125)),
        ))
        db.send_create_signal('django_geo_world', ['Zipcode'])


    def backwards(self, orm):
        # Deleting model 'Zipcode'
        db.delete_table('django_geo_world_zipcode')


    models = {
        'django_geo_world.cityborder': {
            'Meta': {'index_together': "[['name', 'country']]", 'ordering': "['name', 'country']", 'object_name': 'CityBorder'},
        ...
        'django_geo_world.countyborder': {
            'Meta': {'index_together': "[['state_name', 'name']]", 'ordering': "['state_name', 'name']", 'object_name': 'CountyBorder'},
        ...
        'django_geo_world.placepoint': {
            'Meta': {'index_together': "[['st', 'name']]", 'ordering': "['st', 'name']", 'object_name': 'PlacePoint'},
        ...
        'django_geo_world.worldborder': {
            'Meta': {'index_together': "[['lat', 'lon']]", 'ordering': "['name']", 'object_name': 'WorldBorder'},
        ...
        'django_geo_world.zipcode': {
            ...
            'county': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
        ...
        'django_geo_world.zipcodeborder': {
            'Meta': {'index_together': "[['zip', 'state']]", 'ordering': "['zip']", 'object_name': 'ZipcodeBorder'},
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'oid': ('django.db.models.fields.IntegerField', [], {}),
